...
**Docente:** Alexys Herleym Rodríguez Avellaneda, PhD
...
(<https://github.com/pperillav/solar_site_suitability>) y se publicó en el repositorio
oficial de complementos de QGIS (`plugins.qgis.org`) bajo licencia GPL-3.0-or-later; se
